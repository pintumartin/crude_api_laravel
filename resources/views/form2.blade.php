        ...
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="gend" value="male" id="flexCheckDefault" >   
                Male
            </div><div class="form-check">
              <input class="form-check-input" type="radio" name="gend" value="female" id="flexCheckDefault" >   
                Female
            </div>
            <div class="form-check">
